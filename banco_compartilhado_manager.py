...
def registrar_novo_lote(estudo_folder_id: str, estudo_nome: str, nivel: str,
...
def buscar_candidatos(nivel: str, eixo: str, meses_janela: int, excluir_estudo_folder_id: str) -> list:
    """
    Lotes de OUTROS estudos, mesmo nível, mesmo eixo (nome idêntico), dentro
    da janela de meses, e que ainda não bateram o limite de empréstimos.
    """
